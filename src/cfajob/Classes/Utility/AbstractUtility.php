...
abstract class AbstractUtility
{
     ...
     */
    protected static function getUserGroupRepository(): FrontendUserGroupRepository
    {
    ...
    {
        return (array)GeneralUtility::makeInstance(ExtensionConfiguration::class)->get('cfajob');
    }
