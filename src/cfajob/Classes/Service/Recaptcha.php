...
use T3Dev\Cfajob\Controller\AbstractController;

class Recaptcha extends AbstractController
{
    ...
    public function __construct()
    {
        ...
        $this->config =  [
            'client-key' => $config['recaptcha_client_key'],
            'secret-key' => $config['recaptcha_secret_key'],
        ];
    }
